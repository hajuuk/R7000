...
int DefaultVendor=0x1c9e, DefaultProduct=0, TargetVendor=0, TargetProduct=0, TargetClass=0;
...
char NeedResponse=0, InquireDevice=0, sysmode=0;

char imanufact[DESCR_MAX], iproduct[DESCR_MAX], iserial[DESCR_MAX];

char MessageContent[LINE_DIM] = "55534243123456780000000080000606f50402527000000000000000000000";
