 ...
 *
 * $Id: bcmevent.h 437566 2013-11-19 08:51:25Z $
 *
 */
...
#define WLC_E_AUTHORIZED	129	/* event for a STA been authroized for traffic */
#define WLC_E_PROBREQ_RSSI_RATE       130      /* probe request rssi & rate */
#define WLC_E_PROBSUP_IND		131	/* Probe Suppression Indication for a STA */

#define WLC_E_LAST			132	/* highest val + 1 for range checking */
...
/* probsup reason codes */
#define WLC_E_PROBSUP_OTHER_SUP  0  /* suppress with other reasons */
#define WLC_E_PROBSUP_AUTH_SUP   1  /* suppress auth resp. */
#define WLC_E_PROBSUP_PROBE_SUP  2  /* suppress probe resp. */
...
typedef struct _wlc_mgmt_macevt_info
{
	int8 rssi;
	uint32 rspec;
} wlc_mgmt_macevt_info;
