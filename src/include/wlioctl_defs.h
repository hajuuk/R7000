...
#define WL_STA_DWDS		0x08000000	/* DWDS active */
#define WL_STA_DWDS_CAP		0x02000000	/* DWDS CAP */
#define WL_STA_NTGR_SMESH	0x04000000	/* SMESH bit on */
#define WL_STA_BW_20MHZ		0x10000000
#define WL_STA_BW_40MHZ		0x20000000
#define WL_STA_BW_80MHZ		0x40000000
#define WL_STA_BW_160MHZ	0x80000000
...
#define WLC_ECHO				323
#define WLC_GET_ACKSUP			324
#define WLC_SET_ACKSUP			325
#define WLC_LAST				326	/* XXX The last ioctl. Also push this
