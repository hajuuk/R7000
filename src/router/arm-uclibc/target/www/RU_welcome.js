function RU_manual_check_summary()
{
	...
	if(parent.welcome_wan_type == 1)
	{
		...
		if (cf.submit_wan)
		{
			if (parent.mac_spoof == "0")
				cf.submit_wan.value = "4";
			else
				cf.submit_wan.value = "3";
		}
	}
	else if(parent.welcome_wan_type == 2)
	{
		...
		{
			if (parent.mac_spoof == "0")
				cf.submit_wan.value = "2";
			else
				cf.submit_wan.value = "1";
		}
	}
	else if(parent.welcome_wan_type == 3)
	{
		...
		cf.pppoe_dual_gateway.value=parent.pppoe_eth_gateway;
		...
		if (cf.submit_wan)
		{
			...
			{
				if (parent.pppoe_dual_assign == "1")
				{
					if (parent.pppoe_wan_assign == "1")
					{
						cf.submit_wan.value = "88";
					}
					else
					{
						if (parent.mac_spoof == "0")
							cf.submit_wan.value = "6";
						else
							cf.submit_wan.value = "5";
					}
				}
				else
				{
					if (parent.pppoe_wan_assign == "1")
					{
						cf.submit_wan.value = "87";
					}
					else
					{
						if (parent.mac_spoof == "0")
							cf.submit_wan.value = "8";
						else
							cf.submit_wan.value = "7";
					}
				}
			}
			else
			{
				if (parent.mac_spoof == "0")
					cf.submit_wan.value = "18";
				else
					cf.submit_wan.value = "17";
			}
		}
	}
	else if(parent.welcome_wan_type == 4)
	{
		...
		cf.pptp_conn_id.value=parent.pptp_connect_id;
		...
		if (cf.submit_wan)
		{
			if (parent.pptp_local_ipaddr != "")
			{
				if (parent.mac_spoof == "0")
					cf.submit_wan.value = "10";
				else
					cf.submit_wan.value = "9";
			}
			else
			{
				if (parent.mac_spoof == "0")
					cf.submit_wan.value = "12";
				else
					cf.submit_wan.value = "11";
			}
		}
	}
	else if(parent.welcome_wan_type == 5)
	{
		...
		if (cf.submit_wan)
		{
			if (parent.l2tp_local_ipaddr != "")
			{
				if (parent.mac_spoof == "0")
					cf.submit_wan.value = "14";
				else
					cf.submit_wan.value = "13";
			}
			else
			{
				if (parent.mac_spoof == "0")
					cf.submit_wan.value = "16";
				else
					cf.submit_wan.value = "15";
			}
		}
	}
