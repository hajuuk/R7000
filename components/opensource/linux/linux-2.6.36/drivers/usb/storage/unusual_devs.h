...
UNUSUAL_DEV(  0x12d1, 0x143F, 0x0000, 0x0000,
		...
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e220_init,
		0),
UNUSUAL_DEV(  0x2077, 0xf000, 0x0000, 0x0000,
		"Netgear Aircard 3G USB Modem",
		"USB Storage",
		US_SC_DEVICE, US_PR_DEVICE, ntgr_ms_init,
		0),

 UNUSUAL_DEV( 0x12d1, 0x1446, 0x0000, 0x0000,
    "HUAWEI MOBILE",
    "Mass Storage",
    /*Foxconn Modify start, Neil Chen, 10/21/2009 
      This dongle just can be handled by huawei_ms_init */
    //US_SC_DEVICE, US_PR_DEVICE, usb_stor_switch_ports_init,
    US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init4, 
    /* Foxconn Modify end, Neil Chen, 10/21/2009 */
    US_FL_IGNORE_SCSI_DEVICE),   

UNUSUAL_DEV(  0x12d1, 0x14fe, 0x0102, 0x0102,
  "HUAWEI MOBILE",
  "Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init3,
  US_FL_IGNORE_SCSI_DEVICE),

UNUSUAL_DEV(  0x12d1, 0x1505, 0x0000, 0x0000,
		"HUAWEI MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init2,
		US_FL_IGNORE_SCSI_DEVICE),
        
UNUSUAL_DEV(  0x12d1, 0x1f01, 0x0102, 0x0102,
		"HUAWEI MOBILE",
		"Mass Storage",
		//US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init,
		//US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init2,
		//US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e220_init,
		//US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init3,
		//US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init4,
		US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init6,
        US_FL_IGNORE_SCSI_DEVICE),   

UNUSUAL_DEV(  0x12d1, 0x1446, 0x0102, 0x0102,
		"HUAWEI MOBILE",
		"Mass Storage",
		//US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init,
		//US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init2,
		...
		//US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init3,
		//US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init4,
		US_SC_DEVICE, US_PR_DEVICE, huawei_ms_init5,
        US_FL_IGNORE_SCSI_DEVICE),   

/*foxconn Han edited start, 07/28/2014 D-Link DWP-156*/
UNUSUAL_DEV(  0x2001, 0xa403, 0x0300, 0x0300,
		"D-Link,Inc",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, dlink_ms_init,
        US_FL_IGNORE_SCSI_DEVICE),   
/*foxconn Han edited end, 07/28/2014 D-Link DWP-156*/
/*foxconn Han edited start 08/20/2014*/
UNUSUAL_DEV(  0x1c9e, 0x98ff, 0x0000, 0x0000,
		"Micromax",
		"USB Storage",
		US_SC_DEVICE, US_PR_DEVICE, micromax_ms_init,
		0),
UNUSUAL_DEV(  0x1c9e, 0xf000, 0x0000, 0x0000,
		...
		US_SC_DEVICE, US_PR_DEVICE, micromax_ms_init,
		0),
UNUSUAL_DEV(  0x2020, 0x0002, 0x0300, 0x0300,
		"Micromax",
		"USB Storage",
		US_SC_DEVICE, US_PR_DEVICE, micromax_ms_init2,
		0),

/*foxconn Han edited end 08/20/2014*/



UNUSUAL_DEV(  0x15eb, 0x7153, 0x0000, 0x0000,
		"China TeleCom MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, china_telecom_ms_init,
		US_FL_IGNORE_SCSI_DEVICE),
